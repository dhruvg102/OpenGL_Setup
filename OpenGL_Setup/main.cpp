...
// lighting
glm::vec3 lightPos(3.2f, 3.3f, 0.2f);
...
int main()
{
    ...
    unsigned int speculareMap = loadTexture(std::string("resources/textures/container2_specular.png").c_str());
    ...
    Model ourModel(std::string("resources/models/backpack/backpack.obj").c_str());
    Shader ourShader("resources/shaders/modelLoading.vs", "resources/shaders/modelLoading.fs");
